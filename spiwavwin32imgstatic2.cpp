///////////////////////////////////////////////////////////////////////////
// spiwavwin32imgstatic2.cpp : Defines the entry point for the application.
//
...
#include "stdafx.h"
#include "spiwavwin32imgstatic2.h"
#include "FreeImage.h"
	...
	case WM_SIZE:
		{
			...
			*/
			...
			HDC myMemHDC2 = CreateCompatibleDC(NULL);
			::SetMapMode( myMemHDC2, ::GetMapMode(myMemHDC) );
			HBITMAP myhbitmap = CreateCompatibleBitmap(myMemHDC, global_imagewidth, global_imageheight);
